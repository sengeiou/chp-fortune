...
<script type="text/javascript" src="${ctxWebInf}/js/priorityBack/back/backConfirm.js"></script>
<title>优先回款(被退回)详情页</title>
</head>
<body>
<div>
    <div class="title">
        ...
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td colspan="2"><label class="lab"><span class="red">*</span>审批意见：</label>
                	 <textarea rows="4" cols="40" name="checkExamine" disabled="disabled">${view.checkExamine}</textarea>
				</td>
			</tr>
			<tr>
    ...
    <div class="tright mt20 pr30 mb30">
    	...
    	<input type="button" class="btn cf_btn-primary" onclick="revocationApply();" value="撤销">

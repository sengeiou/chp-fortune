...
<title>优先回款申请（被退回）</title>
</head>
<body>
<div class="body_r">
    <form id="searchForm" action="${ctx}/priorityBack/backList" method="post">
    <div class="box1 mb10">
	...
	<div class='box5'>	    	
	<sys:columnCtrl pageToken="myPriority_back_backList"></sys:columnCtrl>
    <table id="listTable" class="table table-striped table-bordered table-condensed data-list-table">
        ...
        <c:forEach items="${page.list}" var="item">
	        <tr>
	            ...
	            <td>${item.orgName }</td>
	            <td class="tcenter">
	            	<auth:hasPermission key="cf:priority:back">
						<a href="${ctx}/priorityBack/backDetail?priorityId=${item.priorityId }" class='cf_btn_edit'>
		            		办理
		            	</a>
					</auth:hasPermission>
	            </td>

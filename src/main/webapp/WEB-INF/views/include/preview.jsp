...
<head>
   ...
   <link href="${ctxWebInf}/js/customertransfer/slider.css" type="text/css" rel="stylesheet" />
   <script src="${ctxWebInf}/js/customertransfer/bootstrap-slider.js" type="text/javascript"></script>
    <style type="text/css">
   ...
   jQuery(document).ready(function($){
	   ...
	   $('.slider').slider({
		    ...
		    zoomEle(1+((ui.value-5)/10),1+((ui.value-5)/10));
		});
		//获取浏览器名称 
...
<div id="myCarousel" class="carousel slide">
   ...
   <!-- 轮播（Carousel）指标 -->
   <ol class="carousel-indicators" id="indicators" style="width:80%;height:1px;">
   ...
   <div class="item active" style="width:90%;height:900px;border:1px solid #ccc;margin-left: auto;margin-right: auto;">
      <iframe width="100%" id="f1" height="100%" scrolling="yes" src="${ctx}/common/file/download/${seletive.attaId}/preview" alt="First slide"></iframe>
      </div>
      <c:forEach items="${list}" var="itemv" varStatus="status">
	<div class="item" style="width:90%;height:900px;border:1px solid #ccc;margin-left: auto;margin-right: auto;">
      <iframe width="100%" id="f1" height="100%" scrolling="yes" src="${ctx}/common/file/download/${itemv.attaId}/preview" alt="Third slide"></iframe>
      </div>
      </c:forEach>
   </div>
   <!-- 轮播（Carousel）导航 -->
   ...
   <a class="right carousel-control" style="width:5%;" href="#myCarousel" 

...
<body>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><label class="lab">证件号码：</label>
                	<!-- 屏蔽客户姓名/手机号/身份证号 -->
               		<input type="text" name="custCertNum" class="cf_input_text178" value="***">
               		<%-- <input type="text" name="custCertNum" class="cf_input_text178" value="${workItem.bv.lenderBegin.customer.custCertNum}"> --%>
                </td>
            </tr>       
            <tr>
					...
					<table id="chengeTable" style="width:100%;">
						...
						<tr>
							<td colspan="2">
								...
								value="${fns:getProvinceLabel(workItem.bv.lenderBegin.customer.address.addrProvince)}&nbsp;${fns:getCityLabel(workItem.bv.lenderBegin.customer.address.addrCity)}&nbsp;${fns:getDistrictLabel(workItem.bv.lenderBegin.customer.address.addrDistrict)}" style='width:300px;'/>
							</td>
							<td style="min-height:0px; border-left:1px solid #DFDFDF;"></td>
							<td colspan="2">
								<label class="lab"><span class="red">*</span>所在地区：</label>
								<input type="text" readonly="readonly" class="cf_input_text178"
								value="${fns:getProvinceLabel(workItem.bv.lenderAfter.customer.address.addrProvince)}&nbsp;${fns:getCityLabel(workItem.bv.lenderAfter.customer.address.addrCity)}&nbsp;${fns:getDistrictLabel(workItem.bv.lenderAfter.customer.address.addrDistrict)}" style='width:300px;'/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								...
								value="***" />
								<%-- <input type="text" readonly="readonly"  class="cf_input_text178"
								value="${workItem.bv.lenderBegin.emer.emerName}" /> --%>
							</td>
							<td style="min-height:0px; border-left:1px solid #DFDFDF;"></td>
							<td colspan="2">
								<!-- 屏蔽客户姓名/手机号/身份证号 -->
								...
								value="***" />
								<%-- <input type="text" readonly="readonly"  class="cf_input_text178"
								value="${workItem.bv.lenderAfter.emer.emerName}" /> --%>
							</td>
						</tr>
						<tr>
							<td>
								<label class="lab"><span class="red">*</span>联系人英文名称：</label><input name="cb_emerName" type="text" value="${workItem.bv.lenderBegin.emer.emerEname}" class="input_text178">			
							</td>
							<!-- 屏蔽客户姓名/手机号/身份证号 -->
							<td>
							...
							<td style="min-height:0px; border-left:1px solid #DFDFDF;"></td>
							<td>
								<label class="lab"><span class="red">*</span>联系人英文名称：</label><input name="ca_emerName" type="text" value="***" class="input_text178">
								<%-- <label class="lab"><span class="red">*</span>联系人英文名称：</label><input name="ca_emerName" type="text" value="${workItem.bv.lenderAfter.emer.emerEname}" class="input_text178"> --%>
							</td>
							<td>
						...
						<tr>
							<td colspan="2">
								...
								<input type="text" readonly="readonly"  style='width:300px;' class="cf_input_text178"
    ...
    <form:form id="searchForm" commandName="workItem" action="${ctx}/lenderChangeApprove/first/dispatch" method="post" >
    <div class='title'>
    ...
    <div class="box6">
        <table class="table1">
            ...
            <tr>
                <td style="width:30%;"><label class="lab"><span class="red">*</span>门店经理审批意见：</label><textarea class="textarea_refuse" id="auditCheckExamine"  name="auditCheckExamine"></textarea></td>
            </tr>
            <tr>
                <td><label class="lab"><span class="red">*</span>门店经理审批结果：</label><input type="radio" required name="auditResult" value="1"/>&nbsp;通过&nbsp;<input type="radio" required name="auditResult" value="2"/>&nbsp;不通过</td>
            </tr>
        </table>
    </div>

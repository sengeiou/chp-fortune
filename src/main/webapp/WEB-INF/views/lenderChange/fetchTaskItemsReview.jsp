...
<html>
<head>
	<title>出借人信息变更复审列表</title>
	<meta name="decorator" content="default"/>
</head>
<body>
    <div class="box1 mb10">
	<form:form id="searchForm" modelAttribute="customer" action="${ctx}/lenderChangeApprove/review/fetchTaskItemsReview" method="post">
	...
	<table id="lenderTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${itemList}" var="item">
			<tr>
			    ...
			    <td>
			    	<auth:hasPermission key="cf:lenderchangeapprovereview:transact">

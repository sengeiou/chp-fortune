...
<html>
<head>
   <script type="text/javascript" src="${ctxWebInf}/js/callCenter/callCenterList4City.js"> </script>
	<script type="text/javascript" src="${ctxWebInf}/js/common/subdialog.js"></script>
	<title>呼叫中心城市客户列表</title>
	<meta name="decorator" content="default" />
</head>
<body>
	<div class="body_r">
    <div class="box1 mb10">
    <form id="searchForm" action="${ctx}/callCenterController/getList4CityManager" method="post" >
          ...
          <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
             <tr>
                ...
                <td>
                	<label class="lab">手机号码：</label><input type="text" class="cf_input_text178"  name="customerTel"  value="${customer.customerMobilephone}">
                </td>
                <td>
                	<label class="lab">身份证号：</label><input type="text" class="cf_input_text178"  name="card"  value="${customer.customerCertNum}">
                </td>
            </tr>  
        </table>
    ...
    <thead>
        ...
        <c:forEach items="${page.list}" var="item">
	        <tr>
	            ...
	            <td>
	            	<a href="javascript:void(0);"  custId="${item.id }"  class="distributeClass" >分配门店</a>
	            </td>
	        </tr>
        </c:forEach>
    </table>

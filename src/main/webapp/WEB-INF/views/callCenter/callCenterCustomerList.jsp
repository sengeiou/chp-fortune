...
<html>
<head>
   <script type="text/javascript" src="${ctxWebInf}/js/callCenter/callCenterCustomerList.js"> </script>
...
<body>
	<div class="body_r">
    <div class="box1 mb10">
    <form id="searchForm" action="${ctx}/callCenterController/getCallCenterCustomerList" method="post" >

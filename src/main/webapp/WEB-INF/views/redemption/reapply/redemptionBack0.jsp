...
<div class="body_r">
    ...
    <form id="applyForm" action="${ctx}/myApply/redemption/reApply" method="post" class="redeem_relaunch">
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
            	<!-- 屏蔽客户姓名/手机号/身份证号 -->
                <td><label class="lab">客户姓名：</label><input type="text" class="cf_input_text178" name="customerName" id="customerName" width="70" value="***" readonly="readonly"/> </td>
                <%-- <td><label class="lab">客户姓名：</label><input type="text" class="cf_input_text178" name="customerName" id="customerName" width="70" value="${workItem.bv.customerName}" readonly="readonly"/> </td>
                 --%><td><label class="lab">客户编号：</label><input type="text" class="cf_input_text178" name="customerCode" width="70" value="${workItem.bv.customerCode}" readonly="readonly"/></td>
                <td><label class="lab">证件号码：</label><input type="text" class="cf_input_text178" name="customerCertNum" width="70" value="***" readonly="readonly"/></td>
                <%-- <td><label class="lab">证件号码：</label><input type="text" class="cf_input_text178" name="customerCertNum" width="70" value="${workItem.bv.customerCertNum}" readonly="readonly"/></td>
                 --%>
            </tr>
        </table>
    </div>
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td><label class="lab">开户行：</label><input type="text" class="cf_input_text178" name="accountBank" width="70" value="${fns:getDictLabel(workItem.bv.accountBank,'tz_open_bank','') }" readonly="readonly"/></td>
                ...
                <td><label class="lab">卡或折：</label><input type="text" class="cf_input_text178" name="accountCardOrBooklet" width="70" value="${fns:getDictLabel(workItem.bv.accountCardOrBooklet,'com_card_type','') }" readonly="readonly"/></td>
            </tr>
            <tr>
                <td><label class="lab">具体支行：</label><input type="text" class="cf_input_text178" name="accountBranch" width="70" value="${workItem.bv.accountBranch}" readonly="readonly"/></td>
                <td><label class="lab">开户姓名：</label><input type="text" class="cf_input_text178" name="accountName" width="70" value="${workItem.bv.accountName}" readonly="readonly"/></td>
                <td><label class="lab">回款账号：</label><input type="text" class="cf_input_text178" name="accountNo" width="70" value="${workItem.bv.accountNo}" readonly="readonly"/></td>
            </tr>
        </table>
    </div>
    <div class="title">
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td><label class="lab">出借编号：</label><input type="text" class="cf_input_text178" name="lendCode" width="70" value="${workItem.bv.lendCode}" readonly="readonly"/</td>
             ...
             <tr>
                <td><label class="lab">合同编号：</label><input type="text" class="cf_input_text178" name="applyContractNo" width="70" value="${workItem.bv.applyContractNo}" readonly="readonly"/></td>
                <td><label class="lab">付款方式：</label><input type="text" class="cf_input_text178" name="applyPay" width="70" value="${fns:getDictLabel(workItem.bv.applyPay,'tz_pay_type','-') }" readonly="readonly"/></td>
				<td><label class="lab">计划出借金额：</label>
					...
					<input type="hidden" id="applyLendMoneyd" class="cf_input_text178" name="applyLendMoneyd" width="70" value="${workItem.bv.applyLendMoneyd}"/>
				</td>
            ...
            <tr>
                <td>
	                <label class="lab"><span class='red'>*</span>赎回申请日期：</label>
				...
				<td><label class="lab"><span class='red'>*</span>赎回类型：</label>
					...
					<input type="radio" name="redemptionType" value="2" <c:if test="${workItem.bv.redemptionType=='2'}">checked="checked"</c:if> onclick="redeemAll();">全部赎回 
					<c:if test="${workItem.bv.redeemPartFlag=='1'}">
						...
						<input id="rtAmount" name="redemptionMoney" type="text" numberWithoutComma="1" onblur="dateCheck(this)" class="cf_input_text178" value="<fmt:formatNumber value="${workItem.bv.redemptionMoney}" 
						type="currency" pattern="##0.00"/>" <c:if test="${workItem.bv.redemptionType=='2'}">style="display:none;"</c:if>>
					</c:if>
				</td>
            </tr>
            <c:if test="${workItem.bv.is161Contract== '1'}">
	            ...
	            <tr>
					...
					<td>
						...
						<input type="text" id="feedbackMoney" name="feedbackMoney" class="cf_input_text178" numberWithoutComma="1" 
							onblur="dateCheck(this)" value="<fmt:formatNumber value="${workItem.bv.feedbackMoney}" type="currency" pattern="##0.00"/>"/>
					</td>
					<td>
						<label class="lab">回馈事项备注(非必填)：</label>
						<input type="text" name="feedbackRemark" class="cf_input_text178" value="${workItem.bv.feedbackRemark}">
					</td>
	            </tr>
            </c:if>
        </table>
        ...
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                ...
                <c:forEach items="${fns:getDictList(workItem.bv.typeStr)}" var="item" varStatus="vs">
	                ...
	                <input type="radio" name="redemptionReceType" value="${item.value }" <c:if test="${workItem.bv.redemptionReceType==item.value}">checked="checked"</c:if>>${item.label}<br/>
                </c:forEach>
                </td>
            </tr>
            <c:if test="${workItem.bv.is161Contract != '1'}">
	            ...
	            <tr>
	                <td>
		                <label class="lab"><span class='red'>*</span>到期日期：</label>
		                <input type="text" id="linitDay" name="linitDay" class="Wdate cf_input_text178" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'applyLendDay\',{});}'})" 
		                value="<fmt:formatDate value='${workItem.bv.linitDay}' pattern='yyyy-MM-dd'/>">
	                </td>
	            </tr>
            </c:if>
        </table>
     ...
     <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
             <tr>
                ...
                <input type="radio" <c:if test="${workItem.bv.checkExaminetype==1}">checked="checked"</c:if> disabled="disabled">通过　
                <input type="radio" <c:if test="${workItem.bv.checkExaminetype==2}">checked="checked"</c:if> disabled="disabled">退回</td>
            </tr>
            <tr>
                <td><label class='lab'>退回原因：</label><input type="text" class="cf_input_text178" value="${workItem.bv.checkExamine}" readonly="readonly"></td>
            </tr>

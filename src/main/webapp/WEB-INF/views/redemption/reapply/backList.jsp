...
<title>提前赎回申请退回</title>
</head>
<body>
	<div class="body_r">
		<div class="box1 mb10">
		<form id="searchForm" action="${ctx}/myApply/redemption/backList" method="post">
			...
			<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td><label class='lab'>城市：</label><sys:cityselect name="city" value="${entity.city}"/></td>
				...
				<tr id="T1" style="display: none;">
					...
					<td>
						...
						<sys:productselect name="productCode" value="${entity.productCode}" multiple="true"/>
					</td>
				</tr>
			</table>
		...
		<div class="box5">
			<sys:columnCtrl pageToken="redemption_backList"></sys:columnCtrl>
			<table class="table table-striped table-bordered table-condensed data-list-table">
				...
				<tr>
					...
					<td class="tcenter">
						<auth:hasPermission key="cf:redemptionapplyfail:transact">

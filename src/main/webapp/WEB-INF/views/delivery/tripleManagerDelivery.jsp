...
<title>三网理财经理交割</title>
<script src="${ctxWebInf}/js/common/autocomplete.js" type="text/javascript"></script>
<script src="${ctxWebInf}/js/delivery/tripleManagerDelivery.js" type="text/javascript"></script>
          ...
          <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    ...
                    <input type="text" class="autoComplete cf_input_text178" id="fManagerCode" onkeyup="getCount(1);" ondblclick="getCount(1);" required>
	...
	<div class="box6">
          <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <label class="lab"><span class="red">*</span>员工编号：</label>
                    <input type="text" class="auto cf_input_text178" id="nfManagerCode" onkeyup="getCount(2);" ondblclick="getCount(2);" required />
       ...
       <div class="tright pr30">
               <label id="custDelivery" style="display:"><input class="btn cf_btn-primary" type="button" id="delivery" value="客户全部交割" /></label>
               <label id="achDelivery" style="display:none"><input class="btn cf_btn-primary" type="button" id="achievement" value="业绩全部交割" /></label>

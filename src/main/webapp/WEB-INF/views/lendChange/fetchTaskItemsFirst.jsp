...
<div class="body_r">
    <div class="box1 mb10">
    <form:form id="searchForm" modelAttribute="queryView" action="${ctx}/lendChangeApprove/fetchTaskItemsFirst" method="post" >
		...
		<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                ...
                <td>
                	...
                	<input type="text"  value="${fns:getOrgNameById(queryView.orgCode)}" readonly="readonly"  class="cf_input_text178" />
                </td>
            </tr>

...
<br/>
<div class="body_r">
      <form:form id="searchForm" commandName="workItem" action="${ctx}/lendChangeReview/review" method="post" >
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
           ...
           <tr>
                <td style="width:15%"><label class="lab" style="width:170px;"><span class="red"></span>数据管理部退回意见：</label><textarea class="textarea_refuse" readonly="readonly">${workItem.bv.changInfoRes.auditCheckExamine}</textarea></td>
            </tr>
            </c:if>
            <tr>
                <td style="width:15%"><label class="lab" style="width:170px;"><span class="red">*</span>业务对接专员审批意见：</label><textarea id="auditCheckExamine" name="auditCheckExamine"  class="textarea_refuse"></textarea></td>
            </tr>
            <tr>
                <td style="width:15%"><label class="lab" style="width:170px;"><span class="red">*</span>对接专员审批结果：</label><input type="radio" required name="auditResult" value="1" />&nbsp;通过&nbsp;<input type="radio" required name="auditResult" value="2" />&nbsp;不通过</td>
            </tr>
        </table>
    </div>
...
<!-- 			<input id="btnCancel" class="btn cf_btn-primary" type="button" value="返 回" onclick="self.location=document.referrer;"/> -->
	...
	<div id="divHideen">
		...
		<input type="hidden" value="${workItem.bv.changeBegin.lendloanapply.applyPay}" name="applyPay"/>
	</div>	
	</form:form> 
</body>
</html>
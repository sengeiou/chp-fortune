...
<div class="navbar navbar-inverse" id="navbar">
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header" role="navigation">
					<ul id="menu" class="nav ace-nav cf_ace-nav">
					<c:set var="firstMenu" value="true"/>
					<c:forEach items="${fns:getMenuList('MODULE_FORTUNE')}" var="menu" varStatus="idxStatus">
				...
				<div class="navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav cf_ace-nav">
						<li><a href="#" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
					    <li style="padding-right: 10px;">
 						  <select id="switchOrgSel" class="form-control" onChange="switchOrg()">
	...
	<script type="text/javascript"> 
		...
		function wSize(){
			...
			htmlObj.css({"overflow-x":strs[1] < minWidth ? "auto" : "hidden", "overflow-y":sidebarHeight > minHeight ? "auto" : "hidden"});
			mainObj.css("width",strs[1] < minWidth ? minWidth - 10 : "auto");
			frameObj.height((strs[0] < minHeight ? minHeight : strs[0]) - (strs[1] < minWidth ? 42 : 28));
			$("#jerichotab").find(".tab_pages").find(".tab_pages").width(minWidth);

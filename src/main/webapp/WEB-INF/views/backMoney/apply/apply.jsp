   ...
   <div class='box6'>
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
            	<td><label class="lab">优先回款：</label><input type="text" class="cf_input_text178" disabled="disabled" value="${fns:dictName(dicts.tz_priority_back,view.priorityBack,'') }"></td>
            </tr>
        </table>
    </div>
    ...
    <form method="post">
        <input type="hidden" id="backmId" name="backmId" value="${view.backmId }"/>
    ...
    <c:if test="${not empty view.checkExaminetype}">
    <div class="title">
        ...
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td><label class="lab"><span class="red">*</span>审批结果：</label>
                	<input name="checkExaminetype" type="radio" class="ml10 mr6" value="1" 
                		<c:if test="${view.checkExaminetype==1}">checked</c:if> disabled="disabled">通过
                	<input name="checkExaminetype" type="radio" class="ml10 mr6" value="2" 
                		<c:if test="${view.checkExaminetype==2}">checked</c:if> disabled="disabled">不通过</td>
                <td colspan="2"><label class="lab">退回原因：</label> 
                	<select class="select180 mr34" id='checkExamine' name='checkExamine' onchange="addReason();" disabled="disabled">
						<option value="">请选择</option>
					...
					<input type="textarea" id="checkReason" class="textarea_min" name="checkReason" 
						value="${view.checkReason }" style="display: none;" disabled="disabled">
				</td>
            </tr>
        </table>
    </div>
    ...
    <div class="tright mt20 pr30 mb30">
    	<input type="button" class="btn cf_btn-primary" onclick="applySubmit();" value="提交">

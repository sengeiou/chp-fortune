        ...
        <table class="table1">
            <tr>
                ...
                <td><label class="lab">银行卡所在城市：</label>
	                ...
	                <select disabled="disabled" class="city-select cf_input_text178">
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                ...
                <td><label class="lab">备注：</label><input type="textarea" class="textarea_min" disabled="disabled" name="backMoneyRemarks" value="${view.backMoneyRemarks }" maxlength='500'></td>
            </tr>
        </table>
    </div>
	<div class="title">
        <div class="l"><h2 class="f14 ml10">操作</h2></div>
    </div>
    <form action="${ctx}/myDone/backMoney/returnBackmoney">
	    <div class="box6">
	        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
	            <tr>
	                <%-- <td width="31%">
	                	<label class="lab"><span class="red">*</span>审批结果：</label>
	                	<input name="checkExaminetype" type="radio" class="ml10 mr6" disabled="disabled" value="1">通过
	                	<input name="checkExaminetype" type="radio" class="ml10 mr6" disabled="disabled" value="2">不通过
	                </td>
	                <td colspan="2">
					</td> --%>
					<td>
	                	<label class="lab"><span class="red">*</span>退回原因：</label>
						...
						<input type="text" id="checkReason" class="textarea_min" name="checkReason" style="display: none;" maxlength='500'>
				    	<input type="button" class="btn btn_sc" onclick="returnBack()" value="退回">
	                </td>

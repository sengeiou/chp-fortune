...
<div class="body_r">
	...
	<form action="${ctx}/myTodo/backMoney/approval" method="post">
	<div class="title">
    ...
    <div class="box6">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                	...
                	<input name="checkExaminetype" type="radio" class="ml10 mr6" value="2" onclick="addReasonChoice();">不通过
                </td>
                <td id="TcheckExamine" style="display: none;" colspan="2"><label class="lab">退回原因：</label> 
					...
					<input type="textarea" id="checkReason" class="textarea_min" name="checkReason" value="${view.backMoneyRemarks }" style="display: none;" maxlength='500'>
				</td>
            </tr>
        </table>
        ...
        <input type="hidden" name="dictFortunechannelflag" value="${view.dictFortunechannelflag}"/>
    </div>
    <div class="tright mt20 pr30">
    	<input type="button" class="btn cf_btn-primary" onclick="approvalSubmit();" value="提交">

...
<div>
        ...
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
		    <tr>
                ...
                <td><label class="lab">实际回款金额：</label>
                	<input type="text" class="cf_input_text178" numberWithoutComma="1" id="backActualbackMoney" name="backActualbackMoney" onblur="dateCheck(this)"value="<fmt:formatNumber value="${view.backActualbackMoney }" type="currency" pattern="#0.00"/>">
                ...
                <!-- 回款日期     -->
               	<td width="31%"><label class="lab"><span class="red">*</span>回款日期：</label>
                	<input type="text" id="backDay" name="backDay" class="Wdate cf_input_text178" onfocus="WdatePicker()" value="<fmt:formatDate value='${view.backMoneyDay }' pattern='yyyy-MM-dd'/>" >
                </td> 
            </tr>
            <tr>
    ...
    <div class="tright mt20 pr30 mb30">
    	<input type="button" class="btn cf_btn-primary" onclick="applyConfirmSubmit();" value="提交">

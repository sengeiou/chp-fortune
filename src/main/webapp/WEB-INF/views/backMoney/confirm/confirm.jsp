...
<div class="body_r">
    <div class="title">
        ...
        <div class="r">
		    <input type="button" onclick="backtoExecute('${view.backmId}','${view.verTime}');" class="btn btn_sc ml10" value="退回到待回款">
            <input type="button" onclick="showFullTrace('${view.lendCode}')" class="btn btn_sc ml10" id="fullTraceBtn" value="全程留痕">
        </div>
    </div>
    <div class="box6">
	...
	<form action="${ctx}/myTodo/backMoney/confirm" method="post">
	<div class="title">
    ...
    <div class="box6">
        ...
        <input type="hidden" name="backmId" id="backmId" value="${view.backmId }"/>
    ...
    <div class="tright mt20 pr30">
    	<input type="button" class="btn cf_btn-primary" onclick="confirmSubmit();" value="提交">

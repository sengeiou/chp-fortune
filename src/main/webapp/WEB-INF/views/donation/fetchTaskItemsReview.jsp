...
<div class="body_r">
    <div class="box1 mb10">
    <form:form id="searchForm" modelAttribute="query" action="${ctx}/donationFinalApprove/fetchTaskItemsReview" method="post" >
		...
		<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
				...
				<sys:orgTree id="org"  name="departmentId" value="${queryView.departmentId}" labelName="departmentName"  labelValue="${queryView.departmentName}" />
                </td>
                <td>
                </td>
            </tr>
    ...
    <table id="lendTable" class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${itemList}" var="item">
            <tr>
			    ...
			    <td>
			    	<auth:hasPermission key="cf:donationmanager:transact">

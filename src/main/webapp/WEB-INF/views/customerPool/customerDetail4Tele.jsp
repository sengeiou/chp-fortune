	...
	<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td>
				...
				<!-- 屏蔽客户姓名/手机号/身份证号 -->
				<input id="custName" name="custName" updateable value="***" type="text" disabled="disabled" class="cf_input_text178" chinese='1' maxlength="50" required='1'>
				<%-- <input id="custName" name="custName" updateable value="${customer.custName}" type="text" disabled="disabled" class="cf_input_text178" chinese='1' maxlength="50" required='1'> --%>
			</td>
			<td>
		...
		<tr>
			<td>
				<label class="lab"><span class='red'>*</span>证件类型：</label><select id="custCertType" name="custCertType" disabled="disabled" class="cf_input_text178">
					<c:forEach items="${dicts.tz_certificate_type }" var="item">
		...
		<tr>
			<td> 
				...
				<input id="custOccupation" name="custOccupation" value="${customer.custOccupation }" type="text" disabled="disabled" class="cf_input_text178">
		
			</td>
			<td>
				<label class="lab"><span class='red'>*</span>单位规模：</label>
				<input id="custUnitScale" name="custUnitScale" value="${customer.custUnitScale }" type="text" disabled="disabled" class="cf_input_text178">
		...
		<tr>
			<td>
				...
				<!-- 屏蔽客户姓名/手机号/身份证号 -->
				<input id="custMobilephone" name="custMobilephone" type="text" updateable maxlength="11" required='1' mobilenum="1" value="***" disabled="disabled" class="cf_input_text178">
				<%-- <input id="custMobilephone" name="custMobilephone" type="text" updateable maxlength="11" required='1' mobilenum="1" value="${customer.custMobilephone }" disabled="disabled" class="cf_input_text178"> --%>
			</td>
			<td>
				<!-- 屏蔽客户姓名/手机号/身份证号 -->
				<label class="lab"><span class='red'>*</span>固定电话：</label>
				<input id="custPhone" name="custPhone" type="text" value="***" updateable maxlength="15" required='1' digits="1" disabled="disabled" class="cf_input_text178">
				<%-- <input id="custPhone" name="custPhone" type="text" value="${customer.custPhone }" updateable maxlength="15" required='1' digits="1" disabled="disabled" class="cf_input_text178"> --%>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<input id="customer_addr" name="address.addr" type="text" updateable maxlength="100" value="${customer.address.addr }" disabled="disabled" class="cf_input_text178">
			</td>
		</tr>
		<tr>
			<td colspan="2"> 
				<label class="lab"><span class='red'>*</span>所在城市：</label>
				<select id="addrProvince" name="address.addrProvince" disabled="disabled" select_required="1" updateable>
					<c:forEach items="${provinceList }" var="item">
						<option value="${item.id}" <c:if test="${item.id==customer.address.addrProvince }">selected=selected</c:if>>${item.areaName }</option>
					</c:forEach>
				</select>
				<select id="addrCity" name="address.addrCity" disabled="disabled" select_required="1" updateable>
					<c:forEach items="${cityList }" var="item">
						<option value="${item.id}" <c:if test="${item.id==customer.address.addrCity }">selected=selected</c:if>>${item.areaName }</option>
					</c:forEach>
				</select>
				<select id="addrDistrict" name="address.addrDistrict" disabled="disabled" select_required="1" updateable>
			...
			<td>
				...
				<input id="customer_addrPostalCode" name="address.addrPostalCode" updateable type="text" value="${customer.address.addrPostalCode }" disabled="disabled" class="cf_input_text178">
			</td>
		</tr>
	</table>
</form>
...
<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		<td>
			<label class="lab"><span class='red'>*</span>证件类型：</label><select id="emerType" name="emergencyContact.emerType" disabled="disabled" class="cf_input_text178">
				<c:forEach items="${dicts.tz_certificate_type }" var="item">

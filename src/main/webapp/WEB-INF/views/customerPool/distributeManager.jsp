    	...
    	<form id="distributeForm" action="${ctx}/customerPoolController/distributeManager" >
          ...
          <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
             <tr>
                ...
                <td><label class="lab">联系电话：</label><input type="text" class="cf_input_text178" name="customerCode" value="***" disabled="true"></td>
                <%-- <td><label class="lab">联系电话：</label><input type="text" class="cf_input_text178" name="customerCode" value="${customerPool.customerTel}" disabled="true"></td> --%>

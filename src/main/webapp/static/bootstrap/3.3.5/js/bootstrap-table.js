...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        this.$selectAll = this.$header.find('input[type="checkbox"].checkAll');
        var initCheckAll = $(this.$el_t).find('th input[type="checkbox"].checkAll')[0];
        var funcInitCheckAll=function(){};
        if($(initCheckAll).data("events") !=null){
        	funcInitCheckAll=$(initCheckAll).data("events").click;
        }
        
        this.$container.off('click', 'input[type="checkbox"].checkAll');
        var cont = this.$container;
        $.each(funcInitCheckAll,function(){
        	cont.on('click', 'input[type="checkbox"].checkAll', this.handler);
        });
    };
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn cf_btn-primary" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn cf_btn-primary" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open %s" title="%s">',
                ...
                '<button type="button" class="btn cf_btn-primary dropdown-toggle" data-toggle="dropdown">',

 ...
 */
public class LendLoanExSearch extends DataEntity<LendLoanExSearch> {
	...
	private String changerTypeName;// 变更类型名称
 	...
 	private String lendAfter;// 变更后信息
	private String lendBegin;// 变更前信息
	private List<String> applyIds;// 申请ID数组
	private List<String> orgIds;// 营业部数组
	private String accountType;// 金账户银行卡变更类型
	...
	public String getLendAfter() {
		return lendAfter;
	}

	public void setLendAfter(String lendAfter) {
		this.lendAfter = lendAfter;
	}

	public String getLendBegin() {
		return lendBegin;
	}

	public void setLendBegin(String lendBegin) {
		this.lendBegin = lendBegin;
	}

...
/**
 * 回款申请列表导出工具
 * @Class Name BmApplyExportor
 * @author 陈广鹏
 * @Create In 2016年4月15日
 */
public class BmApplyExportor extends BmExportor{

	public BmApplyExportor(String filename) {
		super(filename);
	}
	...
	public void assembleExcelCell(ResultSet resultSet, Sheet dataSheet) throws Exception {
		...
		while (resultSet.next()) {
			...
			dataRow.createCell(13).setCellValue(backMoney);
			dataRow.createCell(14).setCellValue(backActualbackMoney);
			dataRow.createCell(15).setCellValue(backMoneyType);
			dataRow.createCell(16).setCellValue(applyPay);
			dataRow.createCell(17).setCellValue(feedbackMoney);
			dataRow.createCell(18).setCellValue(approveDate);
			dataRow.createCell(19).setCellValue(interestDay);
			dataRow.createCell(20).setCellValue(workingState);
			dataRow.createCell(21).setCellValue(zzApproveDate);
			row++;
		}
	}
	...
	public void wrapperHeader(Sheet dataSheet) {
		...
		headerRow.createCell(13).setCellValue("应回款金额");
		headerRow.createCell(14).setCellValue("实际回款金额");
		headerRow.createCell(15).setCellValue("回款类型");
		headerRow.createCell(16).setCellValue("付款方式");
		headerRow.createCell(17).setCellValue("备注"); // 客户回馈金额__回馈事项备注
		headerRow.createCell(18).setCellValue("大金融审核日期");
		headerRow.createCell(19).setCellValue("补息天数");
		headerRow.createCell(20).setCellValue("在职状态");
		headerRow.createCell(21).setCellValue("自转审核日期");
	}

 ...
 */
public class ProductProfit extends DataEntity<ProductProfit> {

	/**
	 * long serialVersionUID 
	 */
	private static final long serialVersionUID = 3634033449965204861L;
	...
	private BigDecimal productYearRate;		// 加息后年化收益率(月息通、信和月增使用)

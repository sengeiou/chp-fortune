package com.creditharmony.fortune.users.entity;
...
public class UserInfo extends DataEntity<UserInfo> {
	...
	//以下字段要从2.0迁移过来
	private String oldOrgId;          //2.0系统使用的组织机构Id
	private String usedLoginName;     //2.0系统使用的登录账号
	private String empCode;           //2.0系统使用的员工号
	private String postName;          //2.0系统使用的岗位名称
	...
	public String getUsedLoginName() {
		return usedLoginName;
	}

	public void setUsedLoginName(String usedLoginName) {
		this.usedLoginName = usedLoginName;
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((oldOrgId == null) ? 0 : oldOrgId.hashCode());
		result = prime * result
		...
		result = prime * result
				+ ((usedLoginName == null) ? 0 : usedLoginName.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (oldLoginName == null) {
			...
			return false;
		if (oldOrgId == null) {
			if (other.oldOrgId != null)
				return false;
		} else if (!oldOrgId.equals(other.oldOrgId))
			return false;
		if (password == null) {
		...
		if (status == null) {
			...
			return false;
		if (usedLoginName == null) {
			if (other.usedLoginName != null)
				return false;
		} else if (!usedLoginName.equals(other.usedLoginName))
			return false;
		if (userCode == null) {

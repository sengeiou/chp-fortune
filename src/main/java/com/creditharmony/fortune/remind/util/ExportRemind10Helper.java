...
/**
 * 导出回息数据帮助类
 * @Class Name ExportRemind10Helper
 * @author 张永生
 * @Create In 2016年4月14日
 */
public class ExportRemind10Helper {

	private static Logger logger = LoggerFactory.getLogger(ExportRemind10Helper.class);
	...
	public static void exportData(Map<String, Object> queryMap,
		...
		try {
			...
			MyBatisSql batisSql = MyBatisSqlUtil
					.getMyBatisSql(
							"com.creditharmony.fortune.remind.dao.RemindDao.exportExlRemind10",
			...
			Sheet dataSheet = wb.createSheet(FileType.Q10TDQ_TXLB.getName());
			...
			response.setHeader(
					"Content-Disposition",
					"attachment; filename="
							+ Encodes.urlEncode(FileType.Q10TDQ_TXLB.getName()+" .xlsx")
							+ ";filename*=UTF-8''"
							+ Encodes.urlEncode(FileType.Q10TDQ_TXLB.getName()+".xlsx"));

package com.creditharmony.fortune.deduct.apply.facade;
 ...
 */
@Service
public class DeductApplyFacade extends CoreManager<DeductApplyDao, DeductPool> {
	 ...
	 * @param applyCode
	 */
	public void update(StringBuffer message, String applyCode) {
		...
		dp.setDictDeductStatus(DeductState.DHKSP.value);
		try {
			// 更新状态为出借审批
			deductApplyManager.batchDeductApplyUpdate(dp);
		} catch (Exception e) {

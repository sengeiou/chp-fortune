...
public class Loanphase extends DataEntity<Loanphase> {
    ...
    private List<String> loanCodes;//借款编号集合
    ...
    public List<String> getLoanCodes() {
		return loanCodes;
	}
	public void setLoanCodes(List<String> loanCodes) {
